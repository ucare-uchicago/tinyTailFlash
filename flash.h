...
struct ssd_info *insert2buffer_modified(struct ssd_info *,unsigned int,int,struct sub_request *,struct request *);
...
int allocate_location(struct ssd_info * ssd ,struct sub_request *sub_req, int parity);
