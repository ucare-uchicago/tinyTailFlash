...
struct ssd_info *buffer_management_modified(struct ssd_info *);
struct ssd_info *distribute_modified(struct ssd_info *);

struct ssd_info *pre_set_page(struct ssd_info *);
